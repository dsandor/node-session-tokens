    ...
    module.exports = function (options) {
        ...
        methods.createSession = function(callback, error){
            ...
            try {
                ...
                var sessionFilePath = Options.sessionStorageBasePath + session.sessionToken;

                if (!fs.existsSync(Options.sessionStorageBasePath)){
                    console.log('Session storage location: %s does not exist, creating.', Options.sessionStorageBasePath);
                    fs.mkdirSync(Options.sessionStorageBasePath);
                }

                console.log('creating session file: %s', sessionFilePath);
...
var localFileStorage = new function(options) {
